...
public class Invoices {
    ...
    public Invoices(int invoice_id, int total_quantity,
            double total_price_before_discount, double discount_percentage,
            double total_price_after_discount, double cashPay, double instaPay,
            double vodafonePay, String username, String invoice_date,
            String clientName, String clientPhone,String reqType, double services, double tax, double delevary) {
     ...
     * @return the delevary
     */
    public double getDelevary() {
        return delevary;
    }

    /**
     * @param delevary the delevary to set
     */
    public void setDelevary(double delevary) {
        this.delevary = delevary;
    }
