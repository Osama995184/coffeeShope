...
public class Sales {
    ...
    public Sales(int sales_id, int invoice_id, int model_id, int quantity, double total_price, String date, String model_name, String type, String inventoryType, double price) {
        this.sales_id = sales_id;
        this.invoice_id = invoice_id;
        this.model_id = model_id;
        this.quantity = quantity;
